...
/* REDOING THE BOARD CLASS, THIS IS THE OLD VERSION
	...
	private final String[] algNot = { "a8", "b8", "c8", "d8", "e8", "f8", "g8", "h8", "a7", "b7", "c7", "d7", "e7",
	...
	public void printBoard() {
		for (int i = 1; i <= BOARD_SIZE; i++)
			if (i % 8 != 0)
				System.out.print(algNot[i - 1] + " ");
			else
				System.out.println(algNot[i - 1]);
	}
	*/
